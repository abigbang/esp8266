...
#define MQTT_HOST            "hcfp3m8.mqtt.iot.bj.baidubce.com" // the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
...
#define MQTT_USER            "hcfp3m8/espesp" // your MQTT login name, if MQTT server allow anonymous login,any string is OK, otherwise, please input valid login name which you had registered
#define MQTT_PASS            "5FPqnVyJdjsWTaPV" // you MQTT login password, same as above
#define STA_SSID 			 "hncc"    // your AP/router SSID to config your device networking
